...
const WalletArtifact = require(config.default.WalletArtifact)

describe('withdrawFunds unit test', async () => {
  ...
  beforeAll(async () => {
    ...
    Wallet = contract(WalletArtifact)
  ...
  it('should take in correct parameters', async () => {
    ...
    try {
      result = await Wallet.withdrawFunds.sendTransaction({
        from: web3Account,
        gas: 250000,

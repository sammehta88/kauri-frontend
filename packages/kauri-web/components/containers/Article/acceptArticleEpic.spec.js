...
describe('acceptArticle unit test', async () => {
  ...
  it('should take in correct parameters', async () => {
    ...
    smartContractPayload.user_id = approvedArticle.user_id
    ...
    try {
      result = await KauriCore.acceptArticle.sendTransaction(
        smartContractPayload.article_id,
        smartContractPayload.id || '',
        smartContractPayload.user_id,

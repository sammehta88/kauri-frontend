...
declare class rxjs$Observable<+T> {
  ...
  static bindCallback<T, T2, T3, T4, T5, U>(
    callbackFunc: (v1: T, v2: T2, v3: T3, v4: T4, v5: T5, callback: (result: U) => any) => any,
    selector?: void,
    scheduler?: rxjs$SchedulerClass
  ): (v1: T, v2: T2, v3: T3, v4: T4, v5: T5) => rxjs$Observable<U>;
  static bindCallback<T, T2, T3, T4, T5, T6, U>(
    callbackFunc: (v1: T, v2: T2, v3: T3, v4: T4, v5: T5, v6: T6, callback: (result: U) => any) => any,
    selector?: void,
    scheduler?: rxjs$SchedulerClass
  ...
  static bindCallback<T, T2, T3, T4, U>(
    callbackFunc: (v1: T, v2: T2, v3: T3, v4: T4, callback: (...args: Array<any>) => any) => any,
    selector: (...args: Array<any>) => U,
    scheduler?: rxjs$SchedulerClass
  ): (v1: T, v2: T2, v3: T3, v4: T4) => rxjs$Observable<U>;
  static bindCallback<T, T2, T3, T4, T5, U>(
    callbackFunc: (v1: T, v2: T2, v3: T3, v4: T4, v5: T5, callback: (...args: Array<any>) => any) => any,
    selector: (...args: Array<any>) => U,
    scheduler?: rxjs$SchedulerClass
  ): (v1: T, v2: T2, v3: T3, v4: T4, v5: T5) => rxjs$Observable<U>;
  static bindCallback<T, T2, T3, T4, T5, T6, U>(
    callbackFunc: (v1: T, v2: T2, v3: T3, v4: T4, v5: T5, v6: T6, callback: (...args: Array<any>) => any) => any,
    selector: (...args: Array<any>) => U,
    scheduler?: rxjs$SchedulerClass
  ): (v1: T, v2: T2, v3: T3, v4: T4, v5: T5, v6: T6) => rxjs$Observable<U>;
  ...
  static bindNodeCallback<T, T2, T3, T4, U>(
    callbackFunc: (v1: T, v2: T2, v3: T3, v4: T4, callback: (err: any, result: U) => any) => any,
    selector?: void,
    scheduler?: rxjs$SchedulerClass
  ): (v1: T, v2: T2, v3: T3, v4: T4) => rxjs$Observable<U>;
  static bindNodeCallback<T, T2, T3, T4, T5, U>(
    callbackFunc: (v1: T, v2: T2, v3: T3, v4: T4, v5: T5, callback: (err: any, result: U) => any) => any,
    selector?: void,
    scheduler?: rxjs$SchedulerClass
  ): (v1: T, v2: T2, v3: T3, v4: T4, v5: T5) => rxjs$Observable<U>;
  static bindNodeCallback<T, T2, T3, T4, T5, T6, U>(
    callbackFunc: (v1: T, v2: T2, v3: T3, v4: T4, v5: T5, v6: T6, callback: (err: any, result: U) => any) => any,
    selector?: void,
    scheduler?: rxjs$SchedulerClass
  ): (v1: T, v2: T2, v3: T3, v4: T4, v5: T5, v6: T6) => rxjs$Observable<U>;
  ...
  static create(subscribe: (observer: rxjs$Observer<T>) => rxjs$ISubscription | Function | void): rxjs$Observable<T>;

  static defer(observableFactory: () => rxjs$Observable<T> | Promise<T>): rxjs$Observable<T>;

  static from(input: rxjs$ObservableInput<T>, scheduler?: rxjs$SchedulerClass): rxjs$Observable<T>;
  ...
  static fromEvent(element: any, eventName: string, selector: () => T, ...none: Array<void>): rxjs$Observable<T>;
  static fromEvent(
    element: any,
    eventName: string,
    options: rxjs$EventListenerOptions,
  ...
  static merge<T, U>(source0: rxjs$Observable<T>, source1: rxjs$Observable<U>): rxjs$Observable<T | U>;
  static merge<T, U, V>(
  ...
  static range(start?: number, count?: number, scheduler?: rxjs$SchedulerClass): rxjs$Observable<number>;
  ...
  concatMap<U>(f: (value: T, index: number) => rxjs$ObservableInput<U>, _: void): rxjs$Observable<U>;
  concatMap<U, V>(
  ...
  exhaustMap<U>(project: (value: T, index: number) => rxjs$ObservableInput<U>, _: void): rxjs$Observable<U>;
  exhaustMap<U, V>(
  ...
  first(predicate?: (value: T, index: number, source: rxjs$Observable<T>) => boolean): rxjs$Observable<T>;
  first<U>(
  ...
  groupBy<K>(keySelector: (value: T) => K, _: void): rxjs$Observable<rxjs$GroupedObservable<K, T>>;
  groupBy<K, V>(
  ...
  last(predicate?: (value: T, index: number, source: rxjs$Observable<T>) => boolean): rxjs$Observable<T>;
  last<U>(
    predicate: ?(value: T, index: number, source: rxjs$Observable<T>) => boolean,
    resultSelector: (value: T, index: number) => U
  ): rxjs$Observable<U>;
  ...
  // Alias for `mergeMap`
  flatMap<U>(project: (value: T, index: number) => rxjs$ObservableInput<U>, concurrency?: number): rxjs$Observable<U>;
  flatMap<U, V>(
    project: (value: T, index: number) => rxjs$ObservableInput<U>,
    resultSelector: (outerValue: T, innerValue: U, outerIndex: number, innerIndex: number) => V,
    concurrency?: number
  ...
  switchMap<U>(project: (value: T, index: number) => rxjs$ObservableInput<U>, _: void): rxjs$Observable<U>;
  switchMap<U, V>(
    project: (value: T, index: number) => rxjs$ObservableInput<U>,
    resultSelector: (outerValue: T, innerValue: U, outerIndex: number, innerIndex: number) => V
  ): rxjs$Observable<V>;
  ...
  mergeMap<U>(project: (value: T, index: number) => rxjs$ObservableInput<U>, concurrency?: number): rxjs$Observable<U>;
  mergeMap<U, V>(
    project: (value: T, index: number) => rxjs$ObservableInput<U>,
    resultSelector: (outerValue: T, innerValue: U, outerIndex: number, innerIndex: number) => V,
    concurrency?: number
  ...
  multicast(subjectOrSubjectFactory: rxjs$Subject<T> | (() => rxjs$Subject<T>)): rxjs$ConnectableObservable<T>;
  ...
  reduce<U>(
    accumulator: (acc: U, currentValue: T, index: number, source: rxjs$Observable<T>) => U,
    seed: U
  ): rxjs$Observable<U>;
  ...
  do(onNext?: (value: T) => mixed, onError?: (error: any) => mixed, onCompleted?: () => mixed): rxjs$Observable<T>;
  do(observer: {
    next?: (value: T) => mixed,
    error?: (error: any) => mixed,
    complete?: () => mixed
  ...
  static combineLatest<A, B>(a: rxjs$Observable<A>, resultSelector: (a: A) => B): rxjs$Observable<B>;
  ...
  static combineLatest<A, B>(a: rxjs$Observable<A>, b: rxjs$Observable<B>, _: void): rxjs$Observable<[A, B]>;
  ...
  combineLatest<A, B>(a: rxjs$Observable<A>, resultSelector: (a: A) => B): rxjs$Observable<B>;
  ...
  static zip<A, B>(a: rxjs$Observable<A>, resultSelector: (a: A) => B): rxjs$Observable<B>;
  ...
  static zip<A, B>(a: rxjs$Observable<A>, b: rxjs$Observable<B>, _: void): rxjs$Observable<[A, B]>;
  ...
  zip<A, B>(a: rxjs$Observable<A>, resultSelector: (a: A) => B): rxjs$Observable<B>;

  zip<A, B, C>(a: rxjs$Observable<A>, b: rxjs$Observable<B>, resultSelector: (a: A, b: B) => C): rxjs$Observable<C>;
  ...
  static forkJoin<A, B>(a: rxjs$Observable<A>, resultSelector: (a: A) => B): rxjs$Observable<B>;
  ...
  static forkJoin<A, B>(a: rxjs$Observable<A>, b: rxjs$Observable<B>, _: void): rxjs$Observable<[A, B]>;
  ...
  withLatestFrom<A, B>(a: rxjs$Observable<A>, resultSelector: (a: A) => B): rxjs$Observable<B>;
...
declare class rxjs$Subscriber<T> extends rxjs$Subscription {
  static create<T>(next?: (x?: T) => void, error?: (e?: any) => void, complete?: () => void): rxjs$Subscriber<T>;

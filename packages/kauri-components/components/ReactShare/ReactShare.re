...
module TwitterIcon = {
  ...
  let make = children =>
    ReasonReact.wrapJsForReason(
      ...
      ~props={"size": iconSize, "round": true},
      children,
    );
};
...
module RedditIcon = {
  let component = ReasonReact.statelessComponent("RedditIcon");

  module Styles = {
    let container =
      Css.(style([width(px(iconSize)), height(px(iconSize))]));
  };
    ...
    render: _self =>
      <div className=Styles.container>
        <svg
          ...
          <g> <circle cx="32" cy="32" r="31" fill="#FF4500" /> </g>
          <g>
            <path
        ...
        <svg
          ...
          <g
            ...
            <g
              ...
              <g
                id="hackernews" transform="translate(151.000000, 2005.000000)">
